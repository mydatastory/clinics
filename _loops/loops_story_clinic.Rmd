...
> #### Question: How would you modify this code for Canada, Germany, and Mexico?
>> The solution is to create a countries vector with a different set of country names.
...
As you can see, a `while()` loop can be a dangerous thing, specifically when no exit condition has been met.  The result, in this case, is a loop to infinity and beyond.  
