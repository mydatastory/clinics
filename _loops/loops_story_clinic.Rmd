...
* Avoid the dreaded infinite loop by always ensuring that its exit condition is met.  In some cases, this will require you to increment an index variable, as is the case with `while` loops.
