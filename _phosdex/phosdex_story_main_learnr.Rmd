---
title: "The Carbuncle Data Debacle (Test)"
output:
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
<p align="center"><img src="images/Barefoot Justine - 00TitleCard.JPG"></p>
...
![](images/3.PNG){width=867px; height=500px}

![](images/4.PNG){width=867px; height=500px}

![](images/Barefoot Justine - 345.gif){width=867px; height=500px}

![](images/8.PNG){width=867px; height=500px}

![](images/9.PNG){width=867px; height=500px}

![](images/10.PNG){width=867px; height=500px}

![](images/11.PNG){width=867px; height=500px}

## Chapter 2

![](images/14.PNG){width=867px; height=500px}

![](images/15.PNG){width=867px; height=500px}

![](images/16.PNG){width=867px; height=500px}

![](images/17.PNG){width=867px; height=500px}

![](images/18.PNG){width=867px; height=500px}

![](images/19.PNG){width=867px; height=500px}

### 

![](images/Barefoot Justine - DogSpotKilroy.jpg){width=100px; height=100px}
...
![](images/Barefoot Justine - DogSpotSeated.jpg){width=100px; height=100px}
...
![](images/26.PNG){width=867px; height=500px}
...
![](images/27.PNG){width=867px; height=500px}

![](images/28.PNG){width=867px; height=500px}

![](images/29.PNG){width=867px; height=500px}

![](images/30.PNG){width=867px; height=500px}

![](images/31.PNG){width=867px; height=500px}

![](images/32.PNG){width=867px; height=500px}

![](images/33.PNG){width=867px; height=500px}

![](images/34.PNG){width=867px; height=500px}

![](images/35.PNG){width=867px; height=500px}

![](images/36.PNG){width=867px; height=500px}

![](images/37.PNG){width=867px; height=500px}
...
![](images/40.PNG){width=867px; height=500px}

![](images/41.PNG){width=867px; height=500px}

![](images/42.PNG){width=867px; height=500px}

![](images/43.PNG){width=867px; height=500px}

![](images/44.PNG){width=867px; height=500px}

![](images/45.PNG){width=867px; height=500px}

![](images/46.PNG){width=867px; height=500px}

![](images/47.PNG){width=867px; height=500px}

![](images/48.PNG){width=867px; height=500px}
...
![](images/50.PNG){width=867px; height=500px}

![](images/51.PNG){width=867px; height=500px}

![](images/52.PNG){width=867px; height=500px}

## Chapter 5

![](images/53.PNG){width=867px; height=500px}

![](images/54.PNG){width=867px; height=500px}

![](images/55.PNG){width=867px; height=500px}

![](images/56.PNG){width=867px; height=500px}
...
![](images/59.PNG){width=867px; height=500px}

![](images/60.PNG){width=867px; height=500px}

![](images/61.PNG){width=867px; height=500px}

![](images/63.PNG){width=867px; height=500px}

![](images/64.PNG){width=867px; height=500px}

![](images/65.PNG){width=867px; height=500px}

![](images/66.PNG){width=867px; height=500px}

![](images/67.PNG){width=867px; height=500px}
