...
# data from February to April.  This is the peak spawning season.  Then create a new data set of 
# average temperatures for each year of the dataset. 
# 
...
# -------------------------------------------------------------------------------------------
# With the smoothing line vectors, create two new dataframes.  Add a year variable, populate
# it with values from 1917 to 1955, and then join both into an analysis dataframe.  Remove rows
# from analysis_df for years when the fishery was shut down.  Plot the new dataset.  Note:
# the landing and temp dataframes are singular to distinguish them from the original (plural) 
# dataframes created earlier.
# -------------------------------------------------------------------------------------------
...
cor(analysis_df$landings, analysis_df$temps)
