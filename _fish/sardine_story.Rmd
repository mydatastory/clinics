...
Pl. 27
**StatCat:** That correlation value is low for the raw data. Let's try the same statistical techniques using the smoothed data. This will allow us to look at the overall trend of ocean temperature in predictor for the sardine landings 
