...
Pl. Intro1
Shot of Wendy talking to her grandfather, Ed Ricketts Jr., in the hospital. 
**Wendy:** What was it like working in Monterey at great grandfather's Western Biological Station? 
...
### How to integrate John Steinbeck into the grandfather's story?

Pl. Intro2
Shot of Wendy and Grandfather looking at a map (Fig 3.1 from sardine_rise_fall article, page 32). Maybe highlight the Central California Fisheries?
...
**Wendy:** Wow! That is a lot of cans of sardines. Weren't people sick of eating it? 
...
**Wendy:** What happened? 
**Grandfather:** That is something that I have never been able to figure out. Did we overfish? Was there something else that impacted the sardine population which left our world forever altered? 

Pl. Intro4
Shot of Grandfather handing a USB drive (?) to Wendy
**Grandfather:** I don't have much time left Wendy if my chemo treatments cannot cure the cancer. Before I got sick, I had gathered all the information I could about the Sardine industry from 1917 to 1967. 
**Wendy:** Grandfather, I am going to dig deep into these data to find out what may have caused the sardine industry to collapse. I promise to find a solution as fast as I can. 
...
Pl. 1 
Shot of Wendy at the computer in her bedroom getting ready to start the analysis of the sardine data. 
...
**Wendy:** Oh wow! That is a lot of data! I think I'm going to need to call on some help from Acme Data Consulting to figure out how to clean this data before I can start the analysis. 

Pl. 4
Split shot of Wendy on the phone talking to DataDog.
**Wendy:** Hi DataDog! I'm in need of some consulting help to figure out how to process this dataset of daily ocean temperatures. Can you help me?
...
**Wendy:** Grandfather, I think I found a reason for why the sardine landings descreased before 1968! 
