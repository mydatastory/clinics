...
**Wendy:** Well, I see in this dataset of ocean temperatures a lot of rows that have the same year. So this must mean that each row in this dataset has a recording of the ocean temperature for that day. [scripps_ocean_temps.csv]
