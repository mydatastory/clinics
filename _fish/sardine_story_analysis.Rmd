...
![](panels/P14.svg){width=1000px; height=1000px}
...
![](panels/P18.svg){width=600px; height=500px}
...
![](panels/P20.svg){width=600px; height=500px}
...
plot(x = analysis_raw_df$avg_temp, y = analysis_raw_df$monterey_tons, 
     ...
     ylab = 'Tons',
     title = "Landings (Tons) by Surface Temperature (Celsius)")
...
![](panels/P24.svg){width=1200px; height=1200px}
...
![](panels/P26.svg){width=600px; height=500px}
...
plot(x = analysis_smooth_df$temps, y = analysis_smooth_df$landings,
     xlab = 'Surface Temp (Celsius)',
     ylab = 'Tons',
     title = "Landings (Tons) by Surface Temperature (Celsius) with Smoothed Data")
