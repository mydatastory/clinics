...
`r tufte::margin_note("Question 7 -- Given the results from our simulator, what can we conclude about the claims for Gum Detoxify?  Does the evidence support or disconfirm the claim that stannous-fluoride infused products like Gum Detoxify reduces gum inflammation and bleeding?)`

## Conclusion
With all of the evidence in-hand, it's time to make a decision.  Do we reject or fail to reject the null hypothesis?  Take note: one never accepts the null hypothesis.  Rather, one *rejects* or *fails to reject* it.

`r tufte::margin_note("Question 8 -- Why do we never accept the null hypothesis?)`
