---
title: "The Peruvian Bird Story (3.0)"
output:
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
![text1](images/Slide2.png){width=867px; height=500px}

![text2](images/Slide3.png){width=867px; height=500px}

![text1](images/slide4.png){width=867px; height=500px}

![text2](images/Slide5.png){width=867px; height=500px}
